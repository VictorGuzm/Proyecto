...
<body>
    <section class="form-register">
        ...
        <form action="proceso/proceso2.php" method="post">
            ...
            <input class="controls" type="password" name="contraseña" id="contraseña" placeholder="Ingrese su Contraseña"required maxlength="10"><br>
